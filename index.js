...
// Validation rule for a valid ID parameter
const validIdParam = [
  param('id')
    .isUUID()
    .withMessage('Id parameter needs to be a UUID')
    .trim()
    .escape(),
];
...
app.put('/todos/:id', validIdParam, validTask, (req, res) => {
  const errors = validationResult(req);
  ...
  mockdata[taskIndex] = { ...mockdata[taskIndex], ...updatedTask };
